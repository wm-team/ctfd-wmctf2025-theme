  ...
  build: {
    ...
    rollupOptions: {
      plugins: [
        copy({
          targets: [
            ...
            {
              src: "./node_modules/@fontsource/inter/files/**/*400*-normal*",
              dest: "static/webfonts",
            },
            {
              src: "./node_modules/@fontsource/inter/files/**/*500*-normal*",
              dest: "static/webfonts",
            },
            {
              src: "./node_modules/@fontsource/inter/files/**/*600*-normal*",
              dest: "static/webfonts",
            },
            {
              src: "./node_modules/@fontsource/inter/files/**/*700*-normal*",
              dest: "static/webfonts",
            },
            {
              src: "./assets/img/**",
      ...
      input: {
        ...
        scoreboard_3d: resolve(__dirname, "assets/js/scoreboard_3d.js"),
